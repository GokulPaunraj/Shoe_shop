  ...
  return (
    <section className="carosal">
      <div className="leftArrow">
        <div className="arrow" onClick={() => handlePreBtn()}>
          <p>&lt;</p>
        </div>
      </div>
      ...
      <div className="slider activeSlider">
        <div className="imgContainer">
          <img src={nike1} alt=""></img>
        </div>
        <div className="sliderContent">
          <div className="category">Casual Shoe</div>
          <h1 className="name">NIKE D.01</h1>
          <div className="description">
            Style at your foot tip.Style at your foot tip.
          </div>
          <div className="buttons">
            <button>Buy Now</button>
            <button>
              <a href="#three">See More</a>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="rightArrow">
        <div className="arrow" onClick={() => handleNextBtn()}>
          <p>&gt;</p>
        </div>
      </div>
    </section>
